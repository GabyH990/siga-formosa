...
<x-app-interno-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            @if ($careerCode === 'TUP')
                {{-- Logo TUP + título --}}
                <img src="{{ asset('image/tup.png') }}" alt="Logo TUP" class="w-8 h-8 object-contain">
                <span class="text-lg font-semibold">Panel Carrera TUP</span>
            @elseif ($careerCode === 'LPB')
                {{-- Logo / ícono LIC: Vioimagen --}}
                <svg viewBox="0 0 1024 1024" class="w-8 h-8 text-violet-500" xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor">
                ...
                <span class="text-lg font-semibold">LIC: Vioimagen</span>
            @else
                <span class="text-lg font-semibold">Panel Principal</span>
            @endif
        </div>
    </x-slot>
    ...
    <div class="space-y-6 relative z-10">
        ...
        @if ($esSuperAdmin ?? false)
            ...
            @if (!$activeCareer)
                ...
                <div class="space-y-4">
                    <h1 class="text-xl font-semibold text-black text-center">Panel Admin</h1>
                    ...
                    <a href="{{ route('panel', ['career' => 'LPB']) }}"
                        ...
                        <div class="flex items-center gap-3">
                            {{-- Icono Carrera --}}
                            <svg viewBox="0 0 1024 1024" class="w-8 h-8 text-blue-500" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" fill="#000000">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <path d="M500.8 766.4c8 4.8 11.2 14.4 6.4 22.4s-14.4 11.2-22.4 6.4l-176-96c-8-4.8-11.2-14.4-6.4-22.4 4.8-8 14.4-11.2 22.4-6.4l176 96z" fill="#050D42"></path>
                                    <path d="M652.8 460.8v-32c57.6 0 86.4 89.6 64 188.8-22.4 96-134.4 179.2-224 179.2v-32c75.2 0 174.4-73.6 192-155.2 19.2-81.6-3.2-148.8-32-148.8zM316.8 908.8h352c9.6 0 16 6.4 16 16s-6.4 16-16 16h-352c-9.6 0-16-6.4-16-16s6.4-16 16-16z" fill="#050D42"></path>
                                    <path d="M652.8 94.4c46.4 27.2 62.4 84.8 35.2 131.2L528 502.4l-166.4-96 160-276.8c25.6-46.4 84.8-60.8 131.2-35.2z" fill="#2F4BFF"></path>
                                    <path d="M336 428.8c-9.6-6.4-14.4-17.6-11.2-24s16-9.6 27.2-3.2l184 107.2c9.6 6.4 14.4 17.6 11.2 24-4.8 8-16 9.6-27.2 3.2L336 428.8z" fill="#050D42"></path>
                                    <path d="M358.4 443.2l139.2 80-24 41.6c-4.8 8-14.4 9.6-22.4 6.4l-110.4-64c-8-4.8-9.6-14.4-6.4-22.4l24-41.6z" fill="#2F4BFF"></path>
                                    <path d="M652.8 444.8m-48 0a48 48 0 1 0 96 0 48 48 0 1 0-96 0Z" fill="#2F4BFF"></path>
                                    <path d="M476.8 828.8v96h32v-96z" fill="#050D42"></path>
                                    <path d="M492.8 780.8m-64 0a64 64 0 1 0 128 0 64 64 0 1 0-128 0Z" fill="#2F4BFF"></path>
                                </g>
                            </svg>
            ...
            @else
                ...
                <div class="flex items-center justify-center gap-3 mb-4">
                    ...
                    @elseif ($activeCareer->codigo === 'LPB')
                        <svg viewBox="0 0 1024 1024" class="w-10 h-10 text-violet-500"
                ...
                {{-- Aviso --}}
                <div
                    class="bg-sky-100 backdrop-blur-md border border-sky-400 shadow rounded-lg p-4 text-black flex justify-between items-center">
                    <div>
                    ...
                    <a href="{{ route('asistencias.index') }}"
                        ...
                        <div class="flex items-center gap-3">
                            <svg viewBox="0 0 16 16" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                ...
                                class="si-glyph si-glyph-person-checked w-8 h-8 text-blue-500" fill="#000000">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <title>178</title>
                                    ...
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <g transform="translate(0.000000, 1.000000)" fill="#3e3cd3">
                                            <path
                                                d="M10.926,3.121 C10.926,4.801 9.617,8.012 8.004,8.012 C6.391,8.012 5.081,4.801 5.081,3.121 C5.081,1.441 6.391,0.081 8.004,0.081 C9.617,0.081 10.926,1.441 10.926,3.121 L10.926,3.121 Z"
                                                class="si-glyph-fill"> </path>
                                            <path
                                                d="M9.033,11.796 L11.426,9.375 L12.705,10.71 L14.348,9.048 C13.717,8.398 12.943,8.05 11.679,8.05 C10.825,9.206 7.99,9.503 7.99,9.503 C7.99,9.503 5.091,9.218 4.237,8.076 C0.144,8.076 0.02,13.986 0.02,13.986 L11.12,13.986 L9.033,11.796 L9.033,11.796 Z"
                                                class="si-glyph-fill"> </path>
                                            <path
                                                d="M15.094,9.801 L12.713,12.182 L11.297,10.765 L10.372,11.689 L12.714,14.03 L16.02,10.726 L15.094,9.801 Z"
                                                class="si-glyph-fill"> </path>
                                        </g>
                                    </g>
                                </g>
                    ...
                    <a href="{{ route('profesores.index') }}"
                        ...
                        <div class="flex items-center gap-3">
                            <svg viewBox="0 -0.5 17 17" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink"
                                class="si-glyph si-glyph-person-man w-8 h-8 text-blue-500" fill="#000000">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <title>737</title>
                                    <defs> </defs>
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <g transform="translate(1.000000, 1.000000)" fill="#252ad0">
                                            <path
                                                d="M8.918,12.338 L7.975,13.958 L7.033,12.338 L7.521,9.042 L8.429,9.042 L8.918,12.338 Z"
                                                class="si-glyph-fill"> </path>
                                            <path
                                                d="M5.534,14 C3.833,11.746 4.378,8.224 4.21,8 C0.123,7.999 0,14 0,14 L5.534,14 Z"
                                                class="si-glyph-fill"> </path>
                                            <path
                                                d="M10.5819092,14 L16,14 C15.999,14 16,7.96850586 12.319458,7.96850586 C12.156458,8.18850586 12.2849092,11.728 10.5819092,14 Z"
                                                class="si-glyph-fill"> </path>
                                            <path
                                                d="M8.00799561,7.94122333 C6.38999561,7.94122333 5,4.732 5,3.064 C5,1.394 6.38899561,0.0581054693 8.00799561,0.0581054693 C9.62799561,0.0581054693 11.0015869,1.39500007 11.0015869,3.06400007 C11.0015869,4.73200007 9.62799561,7.94122333 8.00799561,7.94122333 Z"
                                                class="si-glyph-fill"> </path>
                                        </g>
                                    </g>
                                </g>
        ...
        @else
            ...
            {{-- Título de panel según carrera (si la tenés asociada al bedel) --}}
                ...
                <a href="{{ route('profesores.index') }}"
                    ...
                    <div class="flex items-center gap-3">
                        <svg class="w-8 h-8 text-violet-500" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"
                                d="M12 14s-4 1-4 4v2h8v-2c0-3-4-4-4-4zm0-2a4 4 0 100-8 4 4 0 000 8z" />
                        </svg>
